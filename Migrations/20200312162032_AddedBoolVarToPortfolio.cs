...
{
    public partial class AddedBoolVarToPortfolio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.UserId, x.ArticleId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageProcessed = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerId = table.Column<int>(nullable: true),
                    Sponsored_EmployerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Posts_Employers_Sponsored_EmployerId",
                        column: x => x.Sponsored_EmployerId,
                        principalTable: "Employers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentEmial = table.Column<string>(nullable: true),
                    StudentEmailConfirmed = table.Column<bool>(nullable: false),
                    DateOfBirth = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submissions_Posts_ChallengeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_Sponsored_EmployerId",
                table: "Posts",
                column: "Sponsored_EmployerId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BookmarkedPosts_AspNetUsers_UserId",
                table: "BookmarkedPosts",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Comments_Posts_ArticleId",
                table: "Comments",
                column: "ArticleId",
                principalTable: "Posts",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Portfolios_Photos_PhotoId",
                table: "Portfolios",
                column: "PhotoId",
                principalTable: "Photos",
                principalColumn: "Id",
